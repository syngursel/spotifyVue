        ...
        <section class="content content-full content-boxed overflow-hidden">
          <div class="push-150-t push-150">
            <h1 class="font-s48 font-w700 text-uppercase text-white push-10 visibility-hidden text-center"
                data-toggle="appear" data-class="animated bounceIn">Spotify</h1>
            <h1 class="font-s48 font-w700 text-uppercase text-white push-10 visibility-hidden text-center"
                data-toggle="appear" data-class="animated bounceIn">Ultimate Playlist Creator</h1>
            <h2 class="h3 font-w400 text-white-op push-50 visibility-hidden text-center" data-toggle="appear"
                data-class="animated fadeIn" data-timeout="750">Creating playlists for your taste</h2>
          </div>
          <div class="content content-boxed">
            <div class="row text-center">
              <div class="col-md-4 col-md-offset-4">
                <button class="btn btn-success btn-block btn-rounded push-20 visibility-hidden" data-toggle="appear"
                        data-class="animated fadeIn" data-timeout="950" @click="loginSpotify">
                  Login with Spotify
                </button>
              </div>
            </div>
          ...
          <section class="content content-boxed">
            <div class="push-30">
              <div class="row items-push text-center">
                <div class="col-xs-4 col-md-4 visibility-hidden" data-toggle="appear" data-offset="-100"
                     data-class="animated flipInY" data-timeout="200">
                ...
                <div class="col-xs-4 col-md-4 visibility-hidden" data-toggle="appear" data-offset="-100"
                     data-class="animated flipInY" data-timeout="400">
                  <div class="item item-2x item-circle push-10">
                ...
                <div class="col-xs-4 col-md-4 visibility-hidden" data-toggle="appear" data-offset="-100"
                     data-class="animated flipInY" data-timeout="600">
                  <div class="item item-2x item-circle push-10">
